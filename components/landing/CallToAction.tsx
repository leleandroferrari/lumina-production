  ...
  return (
    <section className="py-32 px-6 md:px-12 bg-white">
      <div
        ...
        style={{ background: `linear-gradient(135deg, #4F46E5 0%, #F472B6 100%)` }}
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="/dashboard" className="w-full sm:w-auto px-12 py-5 bg-white text-slate-900 text-lg font-bold rounded-[24px] hover:scale-[1.05] active:scale-95 transition-all shadow-xl">
              Try for free
            </a>
